...
class Response implements Responsable
{
    ...
    public function basePageRoute(...$args): self
    {
    ...
    public function basePageUrl($url): self
    {
    ...
    public function createBaseRequest(Request $request, $url): Request
    {
